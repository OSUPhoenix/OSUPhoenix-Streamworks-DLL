...
namespace OSWTools
{
    ...
    public partial class OSWLib
    {
        ...
        /// <summary>
        /// Returns the EventType of the action that is currently executing.
        /// Useful for branching logic inside a shared handler.
        ///
        /// USAGE:
        ///   var et = lib.GetEventType();
        ///   if (et == EventType.TwitchCheer) { ... }
        /// </summary>
        public Streamer.bot.Plugin.Interface.Enums.EventType GetEventType()
        {
            try { return _CPH.GetEventType(); }
            catch { return Streamer.bot.Plugin.Interface.Enums.EventType.Unknown; }
        }

        /// <summary>
        /// Returns the source name that triggered the current action
        /// (e.g. the command name, reward name, etc.)
        /// Returns empty string if not available.
        /// </summary>
        public string GetSource()
        {
            try { return _CPH.GetSource() ?? string.Empty; }
